...
class m_Vec2
{
    ...
    m_Vec2( const float* v );//construct vector from float array
...
public:
    ...
    m_Vec3( const float* v );//construct vector from float array
...
inline m_Vec2::m_Vec2( const m_Vec2& v ) :
x(v.x), y(v.y)
{
}
inline m_Vec2::m_Vec2( const float* v ):
x(v[0]), y(v[1])
{
}
...
inline m_Vec3::m_Vec3( const m_Vec3& v ) :
x(v.x), y(v.y), z(v.z)
{
}
inline m_Vec3::m_Vec3( const float* v ):
x(v[0]), y(v[1]), z(v[2])
{
}
